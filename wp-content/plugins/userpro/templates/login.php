...
<div class="userpro userpro-<?php echo $i; ?> userpro-<?php echo $layout; ?>" <?php userpro_args_to_data( $args ); ?>>
	...
	<div class="userpro-head">
		...
		<div class="userpro-right"><a href="#" data-template="<?php echo $args["{$template}_side_action"]; ?>"><?php echo $args["{$template}_side"]; ?></a>
	...
	<div class="userpro-body">
		...
		<form action="" method="post" data-action="<?php echo $template; ?>">
			...
			<div class="userpro-field userpro-submit userpro-column">
	            ...
	            <a href="<?php echo home_url(); ?>/registration" class="userpro-button register-navg" >Register</a>
