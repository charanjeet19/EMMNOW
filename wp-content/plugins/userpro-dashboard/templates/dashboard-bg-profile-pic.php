<div class="profileDashboard dashboardRight" id = "dashboard-bg-upload-pic">
...
<?php
		...
		echo userpro_edit_field( 'custom_profile_bg', $edit_fields['custom_profile_bg'], $i, $args, $user_id );
?>
