...
class CT_Listings_Search extends Widget_Base {
	...
	protected function render() {
		...
		<form id="advanced_search" class="header-search <?php if(!empty($settings['display_type'])) { echo $settings['display_type'] . '-field-search-style'; } ?> <?php if(!empty($settings['display_size'])) { echo $settings['display_size']; } ?> <?php if($settings['search_button_style'] == 'icon') { echo 'search-icon-btn'; } ?>" name="search-listings" action="<?php echo home_url(); ?>">
		<?php
			...
			<?php } else {
	    		...
	    		if ($ct_elementor_adv_search_fields) {			    
		            ...
		            <div class="col span_1 <?php if($settings['search_button_style'] == 'icon') { echo 'search-icon-btn'; } ?>">
						<?php if($settings['search_button_style'] == 'icon') { ?>
