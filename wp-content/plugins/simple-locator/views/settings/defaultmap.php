...
<tr valign="top">
	<td colspan="2">
		<div class="wpsl-default-map">
			<input type="text" id="wpsl_default_search" placeholder="<?php _e('Set location', 'simple-locator'); ?>">
			<button id="wpsl_default_submit" class="button"><?php _e('Search', 'simple-locator'); ?></button>
