...
if(!function_exists('ct_BlogAuthorInfo')) {
	class ct_BlogAuthorInfo extends WP_Widget {
	   ...
	   function form($instance) {
			...
			<p>
			   <label for="<?php echo esc_attr($this->get_field_id('bio')); ?>"><?php esc_html_e('Bio:','contempo'); ?></label>
				<textarea name="<?php echo esc_attr($this->get_field_name('bio')); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('bio')); ?>"><?php echo esc_html($bio); ?></textarea>
			</p>
			<p>
			   <label for="<?php echo esc_attr($this->get_field_id('custom_email')); ?>"><?php esc_html_e('<a href="http://www.gravatar.com/">Gravatar</a> E-mail:','contempo'); ?></label>
			...
			<p>
			   <label for="<?php echo esc_attr($this->get_field_id('avatar_size')); ?>"><?php esc_html_e('Gravatar Size:','contempo'); ?></label>
			   <input type="text" name="<?php echo esc_attr($this->get_field_name('avatar_size')); ?>"  value="<?php echo esc_attr($avatar_size); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('avatar_size')); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('avatar_align')); ?>"><?php esc_html_e('Gravatar Alignment:','contempo'); ?></label>
			...
			<p>
			   <label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Read More Text (optional):','contempo'); ?></label>
			...
			<p>
			   <label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Read More URL (optional):','contempo'); ?></label>
			   <input type="text" name="<?php echo esc_attr($this->get_field_name('read_more_url')); ?>"  value="<?php echo esc_attr($read_more_url); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('page')); ?>"><?php esc_html_e('Visible Pages:','contempo'); ?></label>
				<select name="<?php echo esc_attr($this->get_field_name('page')); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('page')); ?>">
