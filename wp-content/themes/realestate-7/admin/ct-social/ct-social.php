...
class ct_Social extends WP_Widget {
   ...
   function form($instance) {
        ...
        <p>
		   <label for="<?php echo esc_attr($this->get_field_id('dribbble')); ?>"><?php esc_html_e('Dribbble:','contempo'); ?></label>
		   <input type="text" name="<?php echo esc_attr($this->get_field_name('dribbble')); ?>"  value="<?php echo esc_attr($dribbble); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('dribbble')); ?>" />
		</p>
        <p>
        ...
        <p>
		   <label for="<?php echo esc_attr($this->get_field_id('flickr')); ?>"><?php esc_html_e('Flickr:','contempo'); ?></label>
		   <input type="text" name="<?php echo esc_attr($this->get_field_name('flickr')); ?>"  value="<?php echo esc_attr($flickr); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('flickr')); ?>" />
		</p>
        <p>
		   <label for="<?php echo esc_attr($this->get_field_id('foursquare')); ?>"><?php esc_html_e('Foursquare:','contempo'); ?></label>
		   <input type="text" name="<?php echo esc_attr($this->get_field_name('foursquare')); ?>"  value="<?php echo esc_attr($foursquare); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('foursquare')); ?>" />
		</p>
        <p>
		   <label for="<?php echo esc_attr($this->get_field_id('github')); ?>"><?php esc_html_e('GitHub:','contempo'); ?></label>
		   <input type="text" name="<?php echo esc_attr($this->get_field_name('github')); ?>"  value="<?php echo esc_attr($github); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('github')); ?>" />
		</p>
        <p>
		...
		<p>
		   <label for="<?php echo esc_attr($this->get_field_id('medium')); ?>"><?php esc_html_e('Medium:','contempo'); ?></label>
		   <input type="text" name="<?php echo esc_attr($this->get_field_name('medium')); ?>"  value="<?php echo esc_attr($medium); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('medium')); ?>" />
		</p>
        <p>
        ...
        <p>
		   <label for="<?php echo esc_attr($this->get_field_id('skype')); ?>"><?php esc_html_e('Skype:','contempo'); ?></label>
		   <input type="text" name="<?php echo esc_attr($this->get_field_name('skype')); ?>"  value="<?php echo esc_attr($skype); ?>" class="widefat" id="<?php echo esc_attr($this->get_field_id('skype')); ?>" />
		</p>
        <p>
        ...
        <p>
			<label for="<?php echo esc_attr($this->get_field_id('links')); ?>"><?php esc_html_e('Links:', 'contempo'); ?></label> 
